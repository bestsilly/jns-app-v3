...
export const KNOWN_RESOLVER_DATA: KnownResolverData = {
  ...
  '3502': [
    {
      address: '0x9273d1417C3E45FCcC5A5b278ea7d2a08Af7Df8D', // JNS PublicResolver Address
      deployer: 'ENS Labs',
      tag: 'latest',
      isNameWrapperAware: true,
      supportedInterfaces: [
...
export const getKnownResolverData = ({
  ...
  return KNOWN_RESOLVER_DATA[chainId]?.find((data) => data.address === resolverAddress)
}
